...
// Generated for xiAPI version 4.15.03
...
public:
	...
	bool IsBadPixelCorrection();
	
	void EnableBadPixelCorrection();
	void DisableBadPixelCorrection();
	...
	int GetImageCorrectionValue();
	int GetImageCorrectionValue_Maximum();
	int GetImageCorrectionValue_Minimum();
	int GetImageCorrectionValue_Increment();
	void SetImageCorrectionValue(int ImageCorrectionValue);
...
public:
	...
	*/
	void GetImage(xiAPIplus_Image* ret_image){ ret_image= &last_image_;};
